...
Well, I took the plunge; I bought “Node In Action” from Manning Press and finished it last night. Here is my GitHub repo for the code. When I read programming books, I type along with the author in an effort to learn more. The book was fantastic, well written and technically excellent. I had no difficulties with the sample code, which in other books, can be an issue.
